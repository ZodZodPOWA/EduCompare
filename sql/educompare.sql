...
-- Insertion de données dans la table Formation avec logo (BLOB) et pays
INSERT INTO Formation (nom, description, prix, typeEcole, langues, uniforme, internat, tauxReussite, logo, pays) VALUES
('Lycée Privé Saint-Exupéry', 'Un lycée réputé pour ses excellents résultats.', 1500.00, 'Privee', 'Français, Anglais', TRUE, TRUE, 98.5, NULL, 'France'),
('Lycée Public Victor Hugo', 'Un établissement public offrant des formations variées.', 0.00, 'Publique', 'Français', FALSE, FALSE, 85.0, NULL, 'France'),
('École de Commerce XYZ', 'Formation spécialisée en management et commerce international.', 8000.00, 'Privee', 'Anglais', FALSE, TRUE, 90.0, NULL, 'France'),
('École d\'Art Moderne', 'Programme dédié aux arts visuels et au design.', 2000.00, 'Privee', 'Français, Italien', FALSE, FALSE, 88.0, NULL, 'France');
